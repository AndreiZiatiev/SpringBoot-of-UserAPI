...
import cloud.djet.catalog.catalog.domain.Position
import cloud.djet.catalog.catalog.domain.HoursOfOperation
...
class PartyLocationsApiIT : AbstractIntegrationTest<Location>() {

	private val url = "/parties/parent-id/locations"

	@Autowired
	lateinit var repository: PartyLocationsRepository

	@Test
	fun `partyLocationsCreateLocation with required fields`() {
	...
	@Test
	fun `partyLocationsCreateLocation with all fields`() {
	...
	@Test
	fun `partyLocationsGetLocation with required fields`() {
		val res = createWithRequiredFields()
	...
	@Test
	fun `partyLocationsGetLocation with all fields`() {
		val res = createWithAllFields()
		val savedRes = repository.save(res)
	...
	@Test
	fun `partyLocationsGetLocationList api`() {
	...
	@Test
	fun `partyLocationsModifyLocation with all fields`() {
		val res = createWithAllFields()
		val savedRes = repository.save(res)
	...
	@Test
	fun `partyLocationsUpdateLocation with required fields`() {
		val res = createWithRequiredFields()
		val savedRes = repository.save(res)
		savedRes.identity.name = "new identity"
		savedRes.identity.description = "new description"
	...
	@Test
	fun `partyLocationsUpdateLocation with all fields`() {
		val res = createWithAllFields()
		val savedRes = repository.save(res)
		savedRes.identity.name = "new identity"
		savedRes.identity.description = "new description"
